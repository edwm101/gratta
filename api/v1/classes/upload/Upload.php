...
class upload {
     ...
     *
     * By default, the language is english (fr_FR)
     ...
     */
    function  __construct($file, $lang = 'fr_FR')  {
     ...
     */
    function upload($file, $lang = 'fr_FR') {
        ...
        $this->lang               = $lang;
        if ($this->lang != 'fr_FR' && file_exists(dirname(__FILE__).'/lang') && file_exists(dirname(__FILE__).'/lang/class.upload.' . $lang . '.php')) {
            $translation = null;
