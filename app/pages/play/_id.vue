<template>
  <div class="is_rtl">
    ...
    >
      <v-card
        class="elevation-0 shadow mx-auto py-9 px-4"
        tile
        dark
        style="min-height: 100vh; background: rgb(2, 9, 16, 0.8)"
      >
        <v-card
          width="150px"
          class="line-height-0 mx-auto shadow rounded-xl transparent elevation-0"
          :to="{ name: 'index' }"
        >
        ...
        <div class="title text-center" v-else-if="time_down && form.event_date">
          ...
          >
            <v-row dense>
              <v-col cols="3">
                <v-card
                  class="rounded-lg text-center pa-2 py-1 elevation-0 grey lighten-3 black--text font-weight-black"
                >
                  {{ time_down.d }}
        ...
        <div class="line-height-1 pb-1 text-center">
          التاريخ :
        ...
        <div class="py-4">
          <v-container grid-list-xs style="max-width:700px">
            <v-row>
              <v-col cols="12" md="12">
                <v-card class="elevation- shadow transparent">
                  <div
                    class="pa-0 mb-4"
                    v-if="
                      !form.is_start &&
                  ...
                  >
                    <v-btn
                      class="elevation-0 black--text grey lighten-4 rounded-lg border shadow title"
                      x-large
                      block
                      @click="start()"
                  ...
                  <div>
                    ...
                    >
                      <v-btn
                        ...
                        "
                        color="grey"
                        class="mb-3 lighten-2 black--text wave font-weight-black title"
                        x-large
                        block
                        >سجل في القرعة <v-icon>mdi-plus</v-icon></v-btn
                      >
                    </div>
                  </div>
                  <v-card
                    class="elevation-0 pa-2 mt-3 px-3 rounded-lg transparent"
                  >
              ...
              <v-col cols="12" md="12">
                <v-row class="text-center">
                  <v-col cols="12" sm="6">
                    <v-card class="bg-success shadow pa-4" dark>
                  ...
                  <v-col cols="12" sm="6">
                    <v-card class="bg-primary shadow pa-4" dark>
                      <div class="display-1 font-weight-black">
                ...
                <div
                  class="v-data-table v-data-table--fixed-header theme--light mt-6 rounded-lg overflow-hidden"
                >
                  <div class="v-data-table__wrapper">
                    <div class="display-1 font-weight-bold pa-2">الفائزون</div>
      ...
      meta: [
        {
          hid: 'description',
          name: 'description',
          content: 'السحب رقم '+form.number+' - ڨرڨش',
        },
        {
          hid: 'og:title',
          property: 'og:title',
  ...
  methods: {
    ...
    async startRandom() {
      if (this.form.is_start) {
        ...
        this.random_list.push(this.randomIntFromInterval(1000, 100000000))
        this.random_list.push(this.randomIntFromInterval(1000, 100000000))
